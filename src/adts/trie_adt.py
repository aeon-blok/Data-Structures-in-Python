...
class TrieADT(ABC, Generic[T]):
    ...
    def has_children(self, node) -> bool:
        """checks whether specified node has any children"""
        ...
    ...
    def _prune(self, node) -> None:
        """Private Utility Method: removes a node if its not the end node for a key and childless"""
        ...
